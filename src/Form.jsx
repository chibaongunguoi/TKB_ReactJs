    ...
    <ul>
      {subjects.map((subject,index)=>{
       ...
       <div className="function">
        ...
        <button style={{color:'white',backgroundColor:"#007bff",borderColor:'#007bff',marginLeft:"40px"}} onClick={()=>{window.open("https://youtube.com/playlist?list=PLX4N6hFoJoOBBizkL4dK2_fGh_DI7JQzi&si=euHGcERES6tQ9wv7", "_blank");}} id="render">Hướng dẫn sử dụng </button>
      </div>
  </ul>
